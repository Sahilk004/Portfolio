      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container">
            ...
            <div>
                <p className="grid-headtext mt-5">I work remotely across most timezones</p>
                <p className="grid-subtext mt-5">I’m based in India and available for remote work, making it easy to collaborate with teams across different time zones and deliver projects seamlessly.</p>
                <a href="#contact">
